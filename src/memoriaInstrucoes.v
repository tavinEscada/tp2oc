module memoriaInstrucoes(
    ...
    initial begin
        //instrucoes
        memoInst[0] = 32'b00000000101000000000000010010011; //addi x1 , x0 , 10
        memInst[1] = 32'b00000001010000000000000100010011; //addi x2 , x0 , 20
        memInst[2] = 32'b00000110010000000000000110010011; //addi x3 , x0 , 100
        memInst[3] = 32'b00000000000100011010000000100011; //sw x1 , 0( x3 )
        memInst[4] = 32'b00000000000000011010000100000011; //lw x2 , 0( x3 )
        memInst[5] = 32'b00000000010100010000000100010011; //addi x2 , x2 , -5
